...
Product.create(name: "rake", price:126, category_id: 4, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667890529/farm%20apps/rake1_lwpmc7.png")
Product.create(name: "molasses-container", price: 300,category_id: 4, description: "", 
...
Product.create(name: "unbreakable-stainless-steel-thermos", price:300 ,category_id: 4, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667836133/unbreakable-stainless-steel-thermos_hj2tgq.png")
Product.create(name: "poultry-chicken-feeder", price: 300,category_id: 4, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667890523/farm%20apps/poultry-chicken-feeder_npyvkk.png")
Product.create(name: "pin-type-ear-tags", price:300 ,category_id:4 , description: "",
...
Product.create(name: "panga", price: 300,category_id: 4, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667890260/farm%20apps/KL069_3098-244x244_hgnbm7.jpg")
Product.create(name: "hammer", price:78 ,category_id: 4, description: "",
...
Product.create(name: "wheelbarrow", price: 45,category_id:4 , description: "", 
...
Product.create(name: "hamster-cages", price: 78,category_id: 4, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667890236/farm%20apps/Hamster-cages_vpriww.png")
Product.create(name: "bull-calf-cow-restraining-nose-ring", price: 150,category_id:4 , description: "",
...
Product.create(name: "twigazole", price: 300,category_id:5, description: "", 
...
Product.create(name: "twiga-asate-haltry", price: 300,category_id: 5, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667836137/Twigasate-300ml_jc7gwk.png")
Product.create(name: "twiga-rosasol", price: 300,category_id:5 , description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667836143/twiga-rosasol-p-200g_aljral.png")
Product.create(name: "twiga-duduthrin", price: 300,category_id: 5, description: "", 
...
Product.create(name: "twiga-actellic-super-dusting", price:451,category_id: 5, description: "", 
...
Product.create(name: "twiga-actellic-gold-dust", price: 451,category_id: 5, description: "",
     image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667890544/farm%20apps/Twiga-Actellic-Super-Dusting-Powder-50g_Agro-chemicals_27193_1-244x244_wffxja.jpg")
Product.create(name: "simlaw-onion-seeds", price:300,category_id: 5, description: "", 
    image_url: "https://res.cloudinary.com/dghmulj4i/image/upload/v1667890304/farm%20apps/KL261_9070-244x244_nouyyn.jpg")
Product.create(name: "simlaw-beans-seeds-rose-coco", price: 300,category_id:5 , description: "", 
...
Product.create(name: "osho-topcop", price:300 ,category_id: 5, description: "", 
...
Product.create(name: "trevin-dudu-dust", price:300 ,category_id: 5, description: "",
...
Product.create(name: "vital-dry-feeds", price: 300,category_id: 6, description: "", 
...
Product.create(name: "twiga-mineral-block", price: 300,category_id: 6, description: "", 
...
Product.create(name: "twiga-lick-maziwa-zaidi", price: 300,category_id: 6, description: "",
...
Product.create(name: "Tuvune-kienyeji-mash", price: 300,category_id: 6, description: "", 
...
Product.create(name: "masters-growers-mash", price: 98,category_id: 6, description: "", 
